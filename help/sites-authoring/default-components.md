...
Adobe Experience Manager (AEM) comes with various out-of-the-box components that provide comprehensive functionality for website authors. They are available when [editing a page](/help/sites-authoring/editing-content.md). They group them by a main functional area called a component group to aid filtering.

The components are available when [editing a page](/help/sites-authoring/editing-content.md). Group the components by their main functional area (the component group) to aid filtering.
...
* **WeRetail**: Includes the core components proxied for use with the [WeRetail reference implementation](/help/sites-developing/we-retail.md).
...
* [Core Components](https://experienceleague.adobe.com/en/docs/experience-manager-core-components/using/introduction) - The core components offer flexible and feature-rich authoring functionality, which provides essential content types to create pages.
...
* If your page is based on the recommended, modern, editable template, you can [change the template](/help/sites-authoring/templates.md), enable or disable them, and edit parameters for specific components.
* If your page is based on a static template, you can use [design mode](/help/sites-authoring/default-components-designmode.md#enable-disable-components) to enable or disable them, and edit parameters for specific components.
