...
* EPS and AI transformation using ImageMagick (`https://www.imagemagick.org/script/index.php` website) and [Ghostscript](https://www.ghostscript.com/).
...
1. Install [!DNL ImageMagick]: See the ImageMagick documentation at the `https://www.imagemagick.org/script/download.php` website.
