...
| [!UICONTROL Publish Status] | Search predicate to search assets based on their publishing status | <ul><li>Label</li><li>Property name</li><li>Description</li></ul> |
...
| [!UICONTROL Publish Status] | Search predicate to search for assets based on their publishing status | <ul><li>Label</li><li>Property name</li><li>Description</li></ul> |
