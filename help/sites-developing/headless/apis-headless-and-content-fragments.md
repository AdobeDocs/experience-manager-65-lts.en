...
<!--
Adobe Experience Manager (AEM) offers multiple APIs for both structured content delivery from Content Fragments and Content Fragment management. See the individual pages for further details of the specific APIs.

* [AEM Content Fragment Delivery with OpenAPI](/help/sites-developing/headless/aem-content-fragment-delivery-with-openapi.md)
...
* [AEM GraphQL API for Content Fragment delivery](/help/sites-developing/headless/graphql-api/graphql-api-content-fragments.md)
...
* [Content Fragments and Content Fragment Models OpenAPIs](/help/sites-developing/headless/content-fragments-openapis.md)
...
>[!NOTE]
>
>[Content Fragment Support in Assets HTTP API](/help/assets/assets-api-content-fragments.md) is now [deprecated](/help/release-notes/release-notes.md#deprecated-features). It has been replaced by [Content Fragment Delivery with OpenAPI](/help/sites-developing/headless/aem-content-fragment-delivery-with-openapi.md) together with [Content Fragments and Content Fragment Models Management OpenAPIs](/help/sites-developing/headless/content-fragments-openapis.md).
