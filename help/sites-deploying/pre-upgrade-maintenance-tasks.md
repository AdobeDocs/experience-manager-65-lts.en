...
Make sure that you have installed the required index definitions released with the latest AEM 6.5 Service Pack. (Refer to [AEM 6.5 servicepack release notes](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/release-notes/release-notes) for more information). 
