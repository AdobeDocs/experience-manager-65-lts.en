...
>[!NOTE]
>
>The Adaptive Forms feature, available in [AEM 6.5 QuickStart](/help/sites-deploying/deploy.md), is designed for exploration and evaluation purposes only. For production use, it is essential to obtain a valid license for AEM Forms, as Adaptive Forms functionality requires proper licensing.
