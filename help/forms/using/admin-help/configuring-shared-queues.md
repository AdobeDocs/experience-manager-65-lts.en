...
1. On the Manage Access To A User tab, find, and select the user whose queue you want to share. At any point, the bottom-right pane displays the list of users with access to the selected user queue.
...
1. On the Manage Access To A User tab, find, and select the user whose queue you want to manage.
...
1. On the Manage Access to a User tab, find, and select the user whose queue you want to share. At any point, the bottom-right pane displays the list of users with access to the selected user queue.
1. In the bottom-left pane, find and select user queues you want to share with the selected user. Click Share.
1. Click Save to complete.
...
1. On the Manage Access By A User tab, find, and select the user whose queue you want to manage.
