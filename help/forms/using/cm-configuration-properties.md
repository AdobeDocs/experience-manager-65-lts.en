...
description: This topic explains how you can edit Asset Composer with solution-specific configurations.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>The type of rendition the application uses to render the letter preview. </td>
   <td>HTML Rendition</td>
   <td>HTML Rendition / PDF Rendition</td>
  </tr>
  <tr>
   <td><p>Enable CCR PDF highlight</p> </td>
   <td><p>Enables highlighting on PDF in the application.</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Target Highlight Type</p> </td>
   <td><p>Target highlight type in the application.</p> </td>
   <td><p>border</p> </td>
   <td><p>border / fill / none</p> </td>
  </tr>
  <tr>
   <td><p>Target highlight color</p> </td>
   <td><p>Target highlight color in the application.</p> </td>
   <td><p>90;155;245</p> </td>
   <td><p>Any RGB color in format R;G;B</p> </td>
  </tr>
  <tr>
   <td><p>Content Highlight Type</p> </td>
   <td><p>Content highlight type in the application.</p> </td>
   <td><p>Fill</p> </td>
   <td><p>border / fill / none</p> </td>
  </tr>
  <tr>
   <td><p>Content Highlight Color</p> </td>
   <td><p>Content highlight color in the application.</p> </td>
   <td><p>210;225;245</p> </td>
   <td><p>Any RGB color in format R;G;B</p> </td>
  </tr>
  <tr>
   <td><p>Field Highlight Type</p> </td>
   <td><p>Field highlight type in the application.</p> </td>
   <td><p>fill</p> </td>
   <td><p>border / fill / none</p> </td>
  </tr>
  <tr>
   <td><p>Field Highlight Color</p> </td>
   <td><p>Field highlight color in the application.</p> </td>
   <td><p>210;225;245</p> </td>
   <td><p>Any RGB color in format R;G;B</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>PDF Submit Type (type of PDF generated on submitting from the application).</p> </td>
  ...
  <tr>
   ...
   <td><p>Specifies a locale specific display format for data.</p> </td>
   <td><p>locale=en_US; dateFormat=dd-MM-yyyy; numberDecimalSeparator=.; numberGroupSeparator=,; numberUseGroupSeparator=truelocale=de_DE; dateFormat=dd-MM-yyyy; numberDecimalSeparator=,; numberGroupSeparator=.; numberUseGroupSeparator=truelocale=fr_FR; dateFormat=dd-MM-yyyy; numberDecimalSeparator=,; numberGroupSeparator= ; numberUseGroupSeparator=truelocale=ja_JP; dateFormat=dd-MM-yyyy; numberDecimalSeparator=.; numberGroupSeparator=,; numberUseGroupSeparator=true</p> </td>
   <td><p>--</p> </td>
  </tr>
  <tr>
   <td><p>Data Edit Format</p> </td>
   <td><p>Edit format for data. Used when writing data as String or parsing data from String.</p> </td>
   <td><p>locale=en_US; dateFormat=dd-MM-yyyy; numberDecimalSeparator=.; numberGroupSeparator=,; numberUseGroupSeparator=true</p> </td>
   <td>--<p> </p> </td>
  </tr>
  <tr>
   <td><p>Manage Letter Instances on Publish</p> </td>
   <td><p>Enable / Disable the letter functionality (applicable only for Publish Server).</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Enable Audit</p> </td>
   <td><p>Enable / Disable audit functionality. When false, audit logs for all actions are disabled.</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Specify the Maximum number of letters to be kept in the cache.</p> <p>Changing this value results in the clean-up of <code>in-memory</code> cache.</p> </td>
   <td><p>100</p> </td>
   <td><p>Any numeric value</p> </td>
  </tr>
  <tr>
   <td><p>Enable Letter Cache</p> </td>
   <td><p>Enable / Disable the letter cache.</p> <p>Changing this value results in the clean-up of <code>in-memory </code> cache.</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Data Elements Ordering</p> </td>
   <td><p>Keeps data elements ordering in the interface as per their sequence in Letter.</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Support Reload</p> </td>
   <td><p>Enable / Disable reload support in letters rendered on server-side.</p> <p>Disabling improves letter render performance.</p> </td>
   <td><p>false</p> </td>
  ...
  <tr>
   ...
   <td>File system folder location for debugging. If the directory does not <code>exists</code>, no debug dumps are generated.</td>
