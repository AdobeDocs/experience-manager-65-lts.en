...
* Oracle Java&trade; 17/21 (64 bit) (For more details, see more details on [Java Support](#java-support) section.
...
Users experienced repository corruption during online compaction if offline compaction had previously run on the JCR repository. A `SegmentNotFoundException` (SNFE) can occur in this scenario. It can lead to repository corruption.
